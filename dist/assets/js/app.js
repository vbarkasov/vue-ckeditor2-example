...
(function (global, factory) {
            ...
            var Hello = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('vue-ckeditor',{attrs:{"config":_vm.config},on:{"blur":function($event){_vm.onBlur($event);},"focus":function($event){_vm.onFocus($event);}},model:{value:(_vm.content),callback:function ($$v) {_vm.content=$$v;},expression:"content"}})],1)},staticRenderFns: [],_scopeId: 'data-v-5de655f2',
              name: 'hello',
              data: function data() {
                return {
                  content: '',
